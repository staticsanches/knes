...
import dev.staticsanches.kge.engine.KotlinGameEngineBase
...
interface KNESBase : KotlinGameEngineBase {
    val nes: NES
    val mapAsm: MutableMap<UInt16, String>

    val spaceKey: KeyboardKey
    val rKey: KeyboardKey
    val iKey: KeyboardKey
    val nKey: KeyboardKey
    val xKey: KeyboardKey
}

internal fun KNESBase.internalOnUserCreate() {
...
internal fun KNESBase.internalOnKeyEvent(
    key: KeyboardKey,
...
internal fun KNESBase.internalOnUserUpdate(): Boolean {
